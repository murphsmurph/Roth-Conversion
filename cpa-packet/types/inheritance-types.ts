 ...
 * Drop at src/inheritance/types.ts. Extends cpa-packet/types/packet-types.ts.
 *
...
import type { Sourced, Provenance, PersonId, AccountId, FlagSeverity } from './packet-types'
